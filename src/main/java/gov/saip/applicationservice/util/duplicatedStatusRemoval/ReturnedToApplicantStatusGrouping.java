...
public class ReturnedToApplicantStatusGrouping implements StatusProcessor<ApplicationStatusGroupEnum> {
    
    
    private final ApplicationStatusGroupEnum statusGroup;
    
    public ReturnedToApplicantStatusGrouping(ApplicationStatusGroupEnum statusGroupEnum) {
