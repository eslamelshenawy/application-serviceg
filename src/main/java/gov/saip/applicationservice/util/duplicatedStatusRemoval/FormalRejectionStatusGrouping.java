...
public class FormalRejectionStatusGrouping implements StatusProcessor<ApplicationStatusGroupEnum> {
    
    
    private final ApplicationStatusGroupEnum statusGroup;
    
    public FormalRejectionStatusGrouping(ApplicationStatusGroupEnum statusGroupEnum) {
