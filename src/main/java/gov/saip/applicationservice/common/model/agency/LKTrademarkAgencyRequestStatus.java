...
@Entity
@Table(name = "lk_tm_agency_request_status")
@Setter
@Getter
@NoArgsConstructor
public class LKTrademarkAgencyRequestStatus extends BaseLkEntity<Integer> {
    ...
    public LKTrademarkAgencyRequestStatus(Integer id) {
        super(id);
    }

    public LKTrademarkAgencyRequestStatus(String code) {
        super(code);
    }
