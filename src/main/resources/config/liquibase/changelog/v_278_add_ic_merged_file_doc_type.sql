...
VALUES((select max(id)+1 from application.lk_document_type), NULL, NULL, NULL, NULL, 0,
  'INTEGRATED_CIRCUITS', 'وثائق التصميم التخطيطي للدارات المتكاملة', NULL, 'Integrated Circuits Merged Documents', 'الوثائق المدمجة للدارات المتكاملة', 'INTEGRATED_CIRCUITS_MERGED_DOCUMENTS');
