...
INSERT INTO application.lk_steps (id, code, name_ar, name_en)
SELECT (SELECT COALESCE(MAX(id) + 1, 1) FROM application.lk_steps), 'Step1', 'Step1', 'Step1'
    WHERE NOT EXISTS (SELECT 1 FROM application.lk_steps WHERE code = 'Step1')
